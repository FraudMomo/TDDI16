...
class AVL_Tree_Node {
   private:
    ...
    AVL_Tree_Node(const Comparable &element, AVL_Tree_Node *left,
                  AVL_Tree_Node *right)
    ...
    // The following functions are called from corresponding functions in
    // AVL_Tree
 ...
 */
template <typename Comparable>
void AVL_Tree_Node<Comparable>::single_rotate_with_left_child(
    Node_Pointer &k2) {
 ...
 */
template <typename Comparable>
void AVL_Tree_Node<Comparable>::single_rotate_with_right_child(
    Node_Pointer &k1) {
 ...
 */
template <typename Comparable>
void AVL_Tree_Node<Comparable>::double_rotate_with_left_child(
    Node_Pointer &k3) {
 ...
 */
template <typename Comparable>
void AVL_Tree_Node<Comparable>::double_rotate_with_right_child(
    Node_Pointer &k3) {
...
void AVL_Tree_Node<Comparable>::remove(const Comparable &x, Node_Pointer &t) {
    if (t == nullptr) {
        throw AVL_Tree_error("borttagning: element existerar ej");
    }
 ...
 */
template <typename Comparable>
void AVL_Tree_Node<Comparable>::print_tree(ostream &os, const Node_Pointer t,
                                           int depth) {
    if (t != nullptr) {
 ...
 */
template <typename Comparable>
AVL_Tree_Node<Comparable> *AVL_Tree_Node<Comparable>::clone(
    const Node_Pointer t) {
    if (t != nullptr)
 ...
 */
template <typename Comparable>
AVL_Tree_Node<Comparable> *AVL_Tree_Node<Comparable>::find(
    const Comparable &x, const Node_Pointer t) {
    if (t == nullptr)
        return nullptr;
    else if (x < t->element)
 ...
 */
template <typename Comparable>
AVL_Tree_Node<Comparable> *AVL_Tree_Node<Comparable>::find_min(
    const Node_Pointer t) {
    if (t == nullptr)
        return nullptr;
 ...
 */
template <typename Comparable>
AVL_Tree_Node<Comparable> *AVL_Tree_Node<Comparable>::find_max(
    const Node_Pointer t) {
    Node_Pointer p = t;
    if (p != nullptr) {
 ...
 */
template <typename Comparable>
AVL_Tree<Comparable>::AVL_Tree(const AVL_Tree &value)
    : root{Node::clone(value.root)} {}
 ...
 */
template <typename Comparable>
AVL_Tree<Comparable> &AVL_Tree<Comparable>::operator=(
    const AVL_Tree<Comparable> &rhs) {
    AVL_Tree tmp(rhs);
    swap(tmp);
    return *this;
}
...
Comparable &AVL_Tree<Comparable>::find(const Comparable &x) const {
    ...
    if (tmp == nullptr) throw AVL_Tree_error("sökt värde finns ej i trädet");
